...
public class MainActivity extends Activity implements RtmpHandler.RtmpListener,
    ...
    private String rtmpUrl = "rtmp://121.41.57.116/live/test";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSwitchEncoder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (btnSwitchEncoder.getText().toString().contentEquals("soft")) {
                    mPublisher.swithToSoftEncoder();
                    btnSwitchEncoder.setText("hard");
                } else if (btnSwitchEncoder.getText().toString().contentEquals("hard")) {
                    mPublisher.swithToHardEncoder();
                    btnSwitchEncoder.setText("soft");
                }
            }
        });
    }
